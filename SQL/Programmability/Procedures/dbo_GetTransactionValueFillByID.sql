...
-- =============================================
CREATE PROCEDURE [dbo].[GetTransactionValueFillByID] 
	(
...
on a.TransactionCodeID=b.TransactionCodeID where a.TransactionCodeID=@TransactionCodeID order by a.TransactionValueID desc
