ALTER PROCEDURE [dbo].[RePrintPayment] -- RePrintPayment 2,'YES','AA160614',3,1
(
@PaymentID int,
...
begin transaction
   ...
   set @NewPaymentID=@@IDENTITY;
	...
	select @CheckRun=CheckRunID 
	from CheckRun 
	where Status='WORKING' and ProdID=@ProdID

	insert into CheckRunAddon 
	(CheckRunID,PaymentID,CheckNo,Status) 
	values
