ALTER Procedure [dbo].[JournalEntryPayment]   -- JournalEntryPayment 1,78,1,'01','DEV_TEST'
(
@PaymentID int,
@ProdID int,
@UserID int,
...
IF @CheckRunPayment IS NULL -- This means we have a cancelled check
	select @CheckRunPayment= 'CANCELLED ' + cast(CheckRunID as varchar(10)) from CheckRunAddon where Status='Cancelled' and PaymentID=@PaymentID;


set @DescriptionPayment='CheckRun # '+@CheckRunPayment;
PRINT 'dESCRIPTIONpAYENT:' 
PRINT @DescriptionPayment
