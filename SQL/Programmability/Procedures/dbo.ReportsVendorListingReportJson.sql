...
GO
CREATE PROCEDURE [dbo].[ReportsVendorListingReportJson]
...
if @CompanyCode <> ''
set @TheSQL = @TheSQL + '
and  (	V.COAId in (select COAId from COA where SS1  in (select cast(value as int) as CompanyID from string_split(
	replace( replace( replace(@PCompanyCode,''['','''') ,'']'','''') ,''"'','''') ,'','')
)))
order by VendorName
;'
...
declare @ParamDefinition nvarchar(4000) = '
 @PProdID int,
 @PVendorFrom nvarchar(20),
 @PVendorTo nvarchar(20),
 @PCompanyCode  nvarchar(20),
 @PcreatedDateFrom date,
 @PCreatedDateTo date,
 @PVendorType nvarchar(50),
 @PVendorCountry nvarchar(20),
 @PVendorState nvarchar(20),
 --@PDefaultDropdown nvarchar(20),
 @PW9OnFile bit,
 @PW9NotOnFile bit,
 @PUserID int,
 @Ptz  varchar(50)
...
@PcreatedDateFrom=@createdDateFrom,
@PCreatedDateTo=@CreatedDateTo,
@PVendorType =@VendorType ,
@PVendorCountry =@VendorCountry ,
@PVendorState =@VendorState ,
--@PDefaultDropdown =@DefaultDropdown,
@PW9OnFile =@W9OnFile,
@PW9NotOnFile =@W9NotOnFile ,
@PUserID=@UserID,
@Ptz=@tz
;
END
