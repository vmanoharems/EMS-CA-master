...
GO
CREATE PROCEDURE [dbo].[UpsertInvoiceLine] -- UpsertInvoiceLine 1,1,1,0.01,'test','test','test','test',1,1,14,null,null,null,0,'test'
	@InvoiceLineID int,
	@InvoiceID int,
	@COAID int,
	@Amount decimal(18,2),
...
BEGIN
	...
	declare @POLineStatus varchar(50) = 'PendingClose'; -- Default to closing the PO Line
	declare @POID int;
	...
	if (@ClearedFlag = 1) set @POLineStatus = 'Partial';
