...
*/
  ...
  $.ajaxLoad = true;
    ...
    $.defaultPage = '/AdminEMS/Login';
    $.subPagesDirectory = '/Content/AdminPanel/views/';
    $.page404 = '/Content/AdminPanel/views/pages/404.html';
    $.mainContent = $('#ui-view');
...
if ($.ajaxLoad) {
  ...
  $('#AtlasHeaderCurrentProduction').text(localStorage.AdminProdName + " : " + localStorage.AdminProdId);
