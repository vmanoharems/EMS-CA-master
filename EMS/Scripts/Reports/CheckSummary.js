...
var APIUrlPrintPDF = HOST + "/api/ReportP1/CheckSummary";
...
$(document).ready(function () {
    ...
    let SegmentJSON = AtlasUtilities.SegmentJSON(
        {
            "Company": {
                fillElement: '#CRSummaryFilterCompany'
            }
            , "Location": {
                fillElement: '#CRSummaryFilterLocation'
                , ElementGroupID: '#CRSummaryFilterLocationGroup'
                , ElementGroupLabelID: '#CRSummaryFilterLocationLabel'
            }
            , "Episode": {
                fillElement: 'CRSummaryFilterEpisode'
                , ElementGroupID: 'CRSummaryFilterEpisodeGroup'
                , ElementGroupLabelID: 'CRSummaryFilterEpisodeLabel'
            }
            , "Set": {
                fillElement: '#CRSummaryFilterSet'
                , ElementGroupID: '#CRSummaryFilterSetGroup'
                , ElementGroupLabelID: '#CRSummaryFilterSetLabel'
            }
        }
    );
...
function PrintCheckPDF() {
    ...
    var CID = parseFloat($('#CRSummaryFilterCompany').val()[0]);
    ...
    var Type = $('select#ddlType option:selected').val();
    if (Error == '') {
        var Filter = CID + '|' + BankID + '|' + strFinalCheckRun + '|' + Date1 + '|' + Date2 + '|' + Type;
        var JSONParameters = {};
        ...
        RE.ReportTitle = 'Check Register Summary';
        RE.callingDocumentTitle = 'Reports > Banking > Check Register Summary';
        RE.FormCapture('#divCRSummary');
        RE.FormJSON.CRSummary = JSONParameters.callPayload;
