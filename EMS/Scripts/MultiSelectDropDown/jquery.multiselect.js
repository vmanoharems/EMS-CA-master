    ...
    $.fn.multiselect = function( options ){
        ...
        var func = {
            addOption: function( container, option )
            {
                ...
                container.prepend(
                    $('<input type="checkbox" value="" title="" class="multiselect_option" />') // Class Added By Sanjay
                        .val( $(option).val() )
        ...
        return this.each(function(){
            ...
            $(this).after('<div class="ms-options-wrap"><button>Select</button><div class="ms-options"><ul></ul></div></div>');
